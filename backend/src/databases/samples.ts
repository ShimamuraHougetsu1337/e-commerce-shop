...
export const SAMPLE_CATEGORIES = [
  {
    ...
    slug: 'electronics',
    description:
      'Các sản phẩm điện tử, công nghệ hiện đại như điện thoại, laptop, máy tính bảng, phụ kiện công nghệ.',
  ...
  },
  {
    ...
    slug: 'fashion',
    description:
      'Quần áo, giày dép, túi xách và các phụ kiện thời trang nam nữ cho mọi phong cách.',
  ...
  },
  {
    ...
    slug: 'home-living',
    description:
      'Đồ gia dụng, nội thất, trang trí nhà cửa và các sản phẩm phục vụ đời sống hằng ngày.',
  ...
  },
  {
    ...
    slug: 'health-beauty',
    description:
      'Mỹ phẩm, chăm sóc da, thực phẩm chức năng và các sản phẩm chăm sóc sức khỏe làm đẹp.',
  ...
  },
  {
    ...
    description:
      'Dụng cụ thể thao, đồ dã ngoại, trang phục tập luyện và các thiết bị hoạt động ngoài trời.',
  ...
  },
  {
    ...
    slug: 'books',
    description:
      'Sách giáo khoa, sách văn học, truyện tranh, văn phòng phẩm và dụng cụ học tập.',
  ...
  },
  {
    ...
    slug: 'groceries',
    description:
      'Thực phẩm tươi sống, đồ khô, đồ uống, gia vị và các mặt hàng bách hóa thiết yếu hằng ngày.',
...
export const SAMPLE_PRODUCTS = [
  // 1. Thiết bị điện tử (electronics)
  {
    ...
    long_description:
      '<p>iPhone 15 Pro Max là chiếc iPhone đầu tiên sử dụng thiết kế titan hàng không vũ trụ.</p>',
    price: 34990000,
    stock_quantity: 50,
  ...
  },
  {
    ...
    long_description:
      '<p>Trải nghiệm âm thanh tinh khiết với công nghệ chống ồn tiên tiến.</p>',
    price: 7990000,
    stock_quantity: 30,
    category_slug: 'electronics',
    images: [
  ...
  },
  {
    ...
    long_description:
      '<p>Độ chính xác cực cao, hoạt động mượt mà trên mọi bề mặt.</p>',
    price: 2490000,
    stock_quantity: 100,
    category_slug: 'electronics',
    images: [
  ...
  // 2. Thời trang & Phụ kiện (fashion)
  {
    ...
    long_description:
      '<p>Chất liệu cotton tự nhiên, bền màu, không xù lông.</p>',
    price: 250000,
    stock_quantity: 500,
  ...
  },
  {
    ...
    long_description:
      '<p>Công nghệ Aqua Booster bền vững hơn khi tiếp xúc với nước.</p>',
    price: 520000,
    stock_quantity: 150,
    category_slug: 'health-beauty',
    images: [
  ...
  },
  {
    ...
    short_description:
      'Bút cảm ứng chuyên dụng cho mọi dòng máy điện thoại / máy tính bảng dễ thương.',
    long_description:
      '<p>Bút cảm ứng chuyên dụng cho mọi dòng máy điện thoại / máy tính bảng dễ thương.</p>',
    price: 25000,
    stock_quantity: 50,
    category_slug: 'electronics',
    images: [
